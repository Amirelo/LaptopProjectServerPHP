...
CREATE TABLE TBL_COUPON (
	...
	maxEffectValue INTEGER NOT NULL,
...
CREATE TABLE TBL_MEMORY(
	memoryID INTEGER PRIMARY KEY AUTO_INCREMENT,
	currentRAM VARCHAR(100) NOT NULL,
...
CREATE TABLE TBL_OPERATINGSYSTEM(
	operatingSystemID INTEGER PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE TBL_PROCESSOR(
	processorID INTEGER PRIMARY KEY AUTO_INCREMENT,
	name VARCHAR(50) NOT NULL,
	CPU_Speed INTEGER NOT NULL,
	cores INTEGER NOT NULL,
	logicalProcessors INTEGER NOT NULL,
	cacheMemory INTEGER NOT NULL,
    status BIT NOT NULL
);
...
CREATE TABLE TBL_PRODUCTIMAGE(
	productImageID INTEGER PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE TBL_FAVORITE(
	favoriteID INTEGER PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE TBL_RATINGIMAGE(
	ratingImageID INTEGER PRIMARY KEY AUTO_INCREMENT,
	imageLink VARCHAR(255) NOT NULL,
    status INTEGER NOT NULL,
...
INSERT INTO TBL_RATING (RATINGID, DATEADDED,RATING,COMMENT,STATUS, USERID, PRODUCTID) VALUES
(1,"2023-02-01",4.7,"Lovely",true,4,4),
(2,"2023-02-05",4,"Fine",true,9,14),
(3,"2023-02-05",4.3,"Fine",true,5,16),
(4,"2023-02-06",4,"Fine",true,12,21),
(5,"2023-02-07",4,"Fine",true,3,18),

(6,"2023-02-09",3.9,"Super",true,17,13),
(7,"2023-02-11",4,"Fine",true,21,39),
(8,"2023-02-12",4,"Awesome",true,12,1),
(9,"2023-02-12",2.2,"Fine",true,8,39),
(10,"2023-02-14",4,"Fine",true,17,41),

(11,"2023-02-14",4,"Doesn't accept teared cash",true,12,28),
(12,"2023-02-28",3,"Everything in place",true,9,40),
(13,"2023-03-05",4.1,"Doesn't accept teared cash",true,3,14),
(14,"2023-03-08",4,"Everything in place",true,9,27),
(15,"2023-03-09",3.7,"Doesn't accept teared cash",true,11,35),

(16,"2023-03-12",3,"Late",true,2,15),
(17,"2023-03-12",3.3,"Doesn't accept teared cash",true,3,11),
(18,"2023-03-12",3.3,"Everything in place",true,16,12),
(19,"2023-03-14",3,"Late",true,11,15),
(20,"2023-03-17",3.3,"Late",true,17,23),

(21,"2023-03-22",4,"Didn't arrived as said",true,3,8),
(22,"2023-03-25",4.2,"The cover look so cool",true,11,22),
(23,"2023-03-25",3,"Late",true,20,39),
(24,"2023-03-30",4.3,"The cover look so cool",true,14,22),
(25,"2023-04-01",4.5,"The cover look so cool",true,1,14),

(26,"2023-04-01",3.2,"Could've been better",true,6,15),
(27,"2023-04-03",3.1,"Didn't arrived as said",true,8,7),
(28,"2023-04-09",4.1,"Lovely",true,6,3),
(29,"2023-04-11",3.6,"Didn't arrived as said",true,10,17),
(30,"2023-04-12",4.7,"Didn't arrived as said",true,1,39),

(31,"2023-04-12",2,"Could've been better",true,11,27),
(32,"2023-04-17",4.2,"Could've been better",true,5,37),
(33,"2023-04-19",3.2,"Could've been better",true,11,26),
(34,"2023-05-16",4.2,"Could've been better",true,6,38),
(35,"2023-05-21",3.5,"Came at the wrong time",true,7,3),

(36,"2023-06-01",3.7,"Came at the wrong time",true,13,17),
(37,"2023-06-07",4.2,"Came at the wrong time",true,16,23),
(38,"2023-06-11",3.2,"Came at the wrong time",true,6,19),
(39,"2023-06-11",5,"Came at the wrong time",true,22,19),
(40,"2023-06-11",4.1,"Came at the wrong time",true,10,20),

(41,"2023-06-12",4.5,"Fine",true,7,30),
(42,"2023-06-12",3.5,"Fine",true,3,25),
(43,"2023-06-13",3,"Fine",true,18,24),
(44,"2023-06-21",4,"Fine",true,7,14),
(45,"2023-06-24",4.2,"Fine",true,8,19),

(46,"2023-06-27",3.4,"Fine",true,12,34),
(47,"2023-06-28",3.2,"Fine",true,13,4),
(48,"2023-07-23",4,"Lovely",true,2,5),
(49,"2023-07-25",3,"Fine",true,4,29),
(50,"2023-07-04",3.6,"Laptop was not good",true,1,10),

(51,"2023-07-23",3.3,"Late",true,11,9),
(52,"2023-07-09",3.2,"Came too early",true,21,6),
(53,"2023-07-09",3.7,"Good",true,12,11),
(54,"2023-07-19",3.3,"Good",true,8,31),
(55,"2023-07-15",3.3,"Didn't arrived as said",true,1,6),

(56,"2023-07-18",4.1,"Good",true,2,23),
(57,"2023-07-20",4,"My friend love this",true,22,14),
(58,"2023-07-24",4,"Good",true,9,20),
(59,"2023-07-23",4.3,"Didn't arrived as said",true,20,7),
(60,"2023-07-24",3,"Box was broken",true,4,2),


(61,"2023-07-26",3.8,"ok delivery",true,3,36),
(62,"2023-07-26",3.7,"ok delivery",true,7,26),
(63,"2023-07-30",3,"ok delivery",true, 1, 1),
(64,"2023-08-03",4.2,"Great aesthetic",true,19,1),
(65,"2023-08-12",3.5,"Didn't arrived as said",true,18,6),

(66,"2023-08-30",3.4,"Good",true,14,12),
(67,"2023-08-14",3,"Great aesthetic",true,1,29);
...
(1,15290000+200000,15290000,"",4,"Chaos",200000,"2023-02-01","2023-02-01","2023-02-01","2023-02-01",4,4),
(2,65990000+200000,65990000,"",4,"Mekaisto Angélica",200000,"2023-02-05","2023-02-05","2023-02-05","2023-02-05",8,8),
(3,39990000+200000,39990000,"",4,"Nicolaas Jana",200000,"2023-02-05","2023-02-05","2023-02-05","2023-02-05",5,5),
(4,15741000+200000,15741000,"",4,"Batu Cecilio",200000,"2023-02-06","2023-02-06","2023-02-06","2023-02-06",12,12),
(5,32990000+200000,32990000,"",4,"Dierk Syed",200000,"2023-02-07","2023-02-07","2023-02-07","2023-02-07",3,3),

(6,25590000+200000,25590000,"",4,"Lion",200000,"2023-02-09","2023-02-09","2023-02-09","2023-02-09",17,17),
(7,18500000+200000,18500000,"",0,"Darius Taqqiq",200000,"2023-02-11",null,null,null,21,21),
(8,38691000+200000,38691000,"",4,"Affock",200000,"2023-02-12","2023-02-12","2023-02-12","2023-02-12",1,1),
(9,18500000+200000,18500000,"",4,"Thore Patritsiya",200000,"2023-02-12","2023-02-12","2023-02-12","2023-02-12",8,8),
(10,32000000+200000,32000000,"",0,"Tahmasp Angelino",200000,"2023-02-14",null,null,null,17,17),

(11,40000000+200000,40000000,"",4,"Marwa Kenny",200000,"2023-02-14","2023-02-14","2023-02-14","2023-02-14",12,12),
(12,14200000+200000,14200000,"",4,"Əhməd Yentl",200000,"2023-02-28","2023-02-28","2023-02-28","2023-02-28",9,9),
(13,65990000+200000,65990000,"",4,"Roppon",200000,"2023-03-05","2023-03-05","2023-03-05","2023-03-05",3,3),
(14,27450000+200000,27450000,"",0,"Anayeli Sitaram",200000,"2023-03-08",null,null,null,9,9),
(15,8000000+200000,8000000,"",4,"Eyvǫr Yeshua",200000,"2023-03-09","2023-03-09","2023-03-09","2023-03-09",11,11),

(16,46990000+200000,46990000,"",0,"Notus Ethne",200000,"2023-03-12",null,null,null,2,2),
(17,27990000+200000,27990000,"",4,"Ras",200000,"2023-03-12","2023-03-12","2023-03-12","2023-03-12",12,12),
(18,9190000+200000,9190000,"",4,"Qerti",200000,"2023-03-12","2023-03-12","2023-03-12","2023-03-12",14,14),
(19,46990000+200000,46990000,"",4,"Anej Albina",200000,"2023-03-14","2023-03-14","2023-03-14","2023-03-14",11,11),
(20,17991000+200000,17991000,"",4,"Fajr Erminia",200000,"2023-03-17","2023-03-17","2023-03-17","2023-03-17",16,16),

(21,32490000+200000,32490000,"",4,"Mike",200000,"2023-03-22","2023-03-22","2023-03-22","2023-03-22",3,3),
(22,23032000+200000,23032000,"",4,"Tafari Ljupcho",200000,"2023-03-25","2023-03-25","2023-03-25","2023-03-25",11,11),
(23,18500000+200000,18500000,"",0,"Margarita Valeri",200000,"2023-03-25",null,null,null,20,20),
(24,23032000+200000,23032000,"",0,"Trevon Ilya",200000,"2023-03-30",null,null,null,14,14),
(25,65990000+200000,65990000,"",0,"Qianta",200000,"2023-04-01",null,null,null,1,1),

(26,46990000+200000,46990000,"",4,"Gastón Sabela",200000,"2023-04-01","2023-04-01","2023-04-01","2023-04-01",6,6),
(27,20391500+200000,20391500,"",4,"Valora",200000,"2023-04-03","2023-04-03","2023-04-03","2023-04-03",8,8),
(28,17841500+200000,17841500,"",4,"Mob",200000,"2023-04-09","2023-04-09","2023-04-09","2023-04-09",6,6),
(29,37990000+200000,37990000,"",4,"Thamarai Athanasios",200000,"2023-04-11","2023-04-11","2023-04-11","2023-04-11",10,10),
(30,18500000+200000,18500000,"",4,"Apoorva Boyan",200000,"2023-04-12","2023-04-12","2023-04-12","2023-04-12",1,1),

(31,27450000+200000,27450000,"",4,"Matheus Halvor",200000,"2023-04-12","2023-04-12","2023-04-12","2023-04-12",11,11),
(32,20000000+200000,20000000,"",4,"Modron Guðrún",200000,"2023-04-17","2023-04-17","2023-04-17","2023-04-17",5,5),
(33,48000000+200000,48000000,"",4,"Maria Pia Felinus",200000,"2023-04-19","2023-04-19","2023-04-19","2023-04-19",11,11),
(34,9500000+200000,9500000,"",4,"Michel Volodymyr",200000,"2023-05-16","2023-05-16","2023-05-16",null,6,6),
(35,17841500+200000,17841500,"",4,"Mon",200000,"2023-05-21","2023-05-21","2023-05-21",null,7,7),

(36,37990000+200000,37990000,"",0,"Apurva Marinela",200000,"2023-06-01",null,null,null,13,13),
(37,17991000+200000,17991000,"",4,"Lazare Yitro",200000,"2023-06-07","2023-06-07","2023-06-07","2023-06-07",17,17),
(38,29490000+200000,29490000,"",4,"Ravi Michaela",200000,"2023-06-11","2023-06-11","2023-06-11","2023-06-11",6,6),
(39,29490000+200000,29490000,"",4,"Voestaa'e Hardy",200000,"2023-06-11","2023-06-11","2023-06-11","2023-06-11",22,22),
(40,29990000+200000,29990000,"",4,"Sibyl Natálie",200000,"2023-06-11","2023-06-11","2023-06-11","2023-06-11",10,10),

(41,14000000+200000,14000000,"",4,"Matheus Halvor",200000,"2023-06-12","2023-06-12","2023-06-12","2023-06-12",7,7),
(42,45990000+200000,45990000,"",0,"Marwa Kenny",200000,"2023-06-12",null,null,null,3,3),
(43,17091000+200000,17091000,"",0,"Františka Ursella",200000,"2023-06-13",null,null,null,18,18),
(44,65990000+200000,65990000,"",0,"Skyler Ranjeet",200000,"2023-06-21",null,null,null,7,7),
(45,29490000+200000,29490000,"",4,"Tam Nagi",200000,"2023-06-24","2023-06-24","2023-06-24","2023-06-24",8,8),

(46,31000000+200000,31000000,"",4,"Corine Tadesse",200000,"2023-06-27","2023-06-27","2023-06-27","2023-06-27",12,12),
(47,15290000+200000,15290000,"",0,"Heretic",200000,"2023-06-28",null,null,null,13,13),
(48,19341000+200000,19341000,"",2,"Legion",200000,"2023-07-01","2023-07-23",null,null,2,2),
(49,35500000+200000,35500000,"",3,"Maria Pia Felinus",200000,"2023-07-04","2023-07-25","2023-07-25",null,4,4),
(50,14490000+200000,14490000,"",0,"Fohric",200000,"2023-07-04",null,null,null,1,1),

(51,18490000+200000,18490000,"",2,"Geronimo",200000,"2023-07-04","2023-07-23",null,null,11,11),
(52,14841000+200000,14841000,"",1,"Valdoski",200000,"2023-07-09",null,null,null,21,21),
(53,27990000+200000,27990000,"",0,"Rieo",200000,"2023-07-09",null,null,null,3,3),
(54,30000000+200000,30000000,"",3,"Anayeli Sitaram",200000,"2023-07-11","2023-07-19","2023-07-19",null,8,8),
(55,14841000+200000,14841000,"",0,"Vei",200000,"2023-07-15",null,null,null,1,1),

(56,17991000+200000,17991000,"",0,"Natan Anna",200000,"2023-07-18",null,null,null,2,2),
(57,65990000+200000,65990000,"",3,"Yric",200000,"2023-07-18","2023-07-20","2023-07-20",null,22,22),
(58,29990000+200000,29990000,"",3,"Eha Akmal",200000,"2023-07-21","2023-07-24","2023-07-24",null,9,9),
(59,20391500+200000,20391500,"",3,"Emina",200000,"2023-07-21","2023-07-23","2023-07-23",null,20,20),
(60,15921000+200000,15921000,"",3,"Flow",200000,"2023-07-23","2023-07-23","2023-07-24",null,4,4),

(61,17000000+200000,17000000,"",3,"Lishan Philandros",200000,"2023-07-24","2023-07-26","2023-07-26",null,3,3),
(62,48000000+200000,48000000,"",3,"Arshtat Mahihkan",200000,"2023-07-25","2023-07-26","2023-07-26",null,7,7),
(63,38691000+200000,38691000,"",0,"Ben",200000,"2023-07-30",null,null,null,19,19),
(64,38691000+200000,38691000,"",4,"Utiora",200000,"2023-08-03","2023-08-03","2023-08-03","2023-08-03",12,12),
(65,14841000+200000,14841000,"",4,"Rakar",200000,"2023-08-12","2023-08-12","2023-08-12","2023-08-12",18,18),


(66,35500000+200000,35500000,"",4,"Arshtat Mahihkan",200000,"2023-08-14","2023-08-14","2023-08-14","2023-08-14",1,1),
(67,9190000+200000,9190000,"",4,"Possum",200000,"2023-08-30","2023-08-30","2023-08-30","2023-08-30",16,16);
...
INSERT INTO TBL_NOTIFICATION (NOTIFICATIONID,TITLE,DETAIL,CREATEDDATE,DISABLEDATE,STATUS,USERID) VALUES
(1, "Order placement Success", "You order have been submited, we're waiting for admin verification","2023-02-07",null,2,3),
(2, "Order verifed", "We're preparing the ordered item(s) for delivery","2023-02-07",null,2,3),
(3, "Order On the way", "Order are being delivered to your place","2023-02-07",null,2,3),
(4, "Order Completed", "Order delivered, have a good day","2023-02-07",null,2,3),

(5, "Order placement Success", "You order have been submited, we're waiting for admin verification","2023-03-05",null,2,3),
(6, "Order verifed", "We're preparing the ordered item(s) for delivery","2023-03-05",null,2,3),
(7, "Order On the way", "Order are being delivered to your place","2023-03-05",null,2,3),
(8, "Order Completed", "Order delivered, have a good day","2023-03-05",null,2,3),

(9, "Order placement Success", "You order have been submited, we're waiting for admin verification","2023-03-12",null,2,3),
(10, "Order verifed", "We're preparing the ordered item(s) for delivery","2023-03-12",null,2,3),
(11, "Order On the way", "Order are being delivered to your place","2023-03-12",null,2,3),
(12, "Order Completed", "Order delivered, have a good day","2023-03-12",null,2,3),

(13, "Order placement Success", "You order have been submited, we're waiting for admin verification","2023-03-22",null,2,3),
(14, "Order cancel", "The order has been canceled","2023-03-22",null,2,3),

(15, "Order placement Success", "You order have been submited, we're waiting for admin verification","2023-06-12",null,2,3),
(16, "Order cancel", "The order has been canceled","2023-06-12",null,2,3),

(17, "Order placement Success", "You order have been submited, we're waiting for admin verification","2023-07-26",null,1,3),
(18, "Order verifed", "We're preparing the ordered item(s) for delivery","2023-07-26",null,1,3),
(19, "Order On the way", "Order are being delivered to your place","2023-07-26",null,1,3),
(20, "Order Completed", "Order delivered, have a good day","2023-07-26",null,1,3);
